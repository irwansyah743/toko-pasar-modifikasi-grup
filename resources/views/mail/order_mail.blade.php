                    ...
                    <tr>
                        <td class="header"
                            ...
                            <a href="{{ url('') }}"
                                ...
                                <img src="{{ asset('front-theme/assets/images/logo.png') }}" class="logo"
                                    alt="VamoStore"
                                    style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; max-width: 100%; border: none; height: 75px; width: 130px;">
                            </a>
                        </td>
                    </tr>
                                ...
                                <tr>
                                    <td class="content-cell"
                                        ...
                                        <p
                                            ...
                                            You made a transaction in tokoPasarModifikasiGrup on {{ $order['time'] }} .</p>
                                            ...
                                            <tr>
                                                <td align="center"
                                                    ...
                                                    <table width="100%" border="0" cellpadding="2" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            <td align="center"
                                                                style="box-sizing: border-box; width:100%; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative;">
                                                                <table border="0" cellpadding="0" cellspacing="0"
                                                                    ...
                                                                    <tr>
                                                                        <td style="padding-right: 8px;"> Amount</td>
                                                                        <td>{{ $order['amount'] }}</td>
                                                                    </tr>
                                                                    <tr>
                                                                    ...
                                                                    <tr>
                                                                        <td style="padding-right: 8px;"> Payment Status
                                                                        </td>
                                ...
                                <tr>
                                    <td class="content-cell" align="center"
                                        ...
                                        <p
                                            ...
                                            © 2023 tokoPasarModifikasiGrup. All rights reserved.</p>
